...
namespace Domain
{
    ...
    {
        private ISet<Registration> registrations = new HashedSet<Registration>();
        private ISet<Guid> passedClasses = new HashedSet<Guid>();
        private ISet<Guid> failedClasses = new HashedSet<Guid>();
